---
title: "ggplot2 그래프 시각화"
output: 
  html_document:
    toc: true
    toc_float: true
    keep_md: true
date: '2022-06-23 10:48:04'
---
...
# 눈금 라벨의 텍스트 변경하기
p <- ggplot(data=heightweight, aes(x = ageYear, y = heightIn)) + 
  geom_point() + 
  theme_bw()
...
# 4. 테마 요소의 외형 변경하기 예제
p <- ggplot(data=heightweight, aes(x = ageYear, y = heightIn, colour = sex)) + geom_point()
